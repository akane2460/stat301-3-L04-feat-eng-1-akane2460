...
load(here("recipes/recipe_simple.rda"))
...
tic("Neural Networks: Simple Recipe") # start clock

# tuning code in here
tune_neural_net_simple <- neural_net_model |> 
  tune_grid(
...
save(tune_neural_net_simple, tictoc_simple,
     file = here("results/tune_nn_simple.rda"))
